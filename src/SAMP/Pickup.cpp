...
///////////////////////////////////////////////
Pickup Pickup::create(int modelIdx_, int type_, Vec3f const& pos_, int virtualWorld_)
{
	return Pickup::create(modelIdx_, type_, pos_.x, pos_.y, pos_.z, virtualWorld_);
}

///////////////////////////////////////////////
Pickup Pickup::create(int modelIdx_, int type_, float x_, float y_, float z_, int virtualWorld_)
{
	return Pickup{ sampgdk_CreatePickup(modelIdx_, type_, x_, y_, z_, virtualWorld_) };
}
